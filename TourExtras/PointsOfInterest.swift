...
class PointsOfInterest {
    ...
    init() {
        var stuff = ImageContent(image: UIImage(named: "30.png")!, text: "30 Ocean Ave front")
        self.places.append(PointOfInterest(label: "30 Ocean Ave", center: CLLocationCoordinate2D(latitude: 42.508605, longitude: -70.889498), radius: 100, images: [stuff]))
        stuff = ImageContent(image: UIImage(named: "22.png")!, text: "")
        self.places.append(PointOfInterest(label: "22 Ocean Ave", center: CLLocationCoordinate2D(latitude: 42.508663, longitude: -70.889065), radius: 100, images: [stuff]))
        stuff = ImageContent(image: UIImage(named: "21.png")!, text: "")
        self.places.append(PointOfInterest(label: "21 Ocean Ave", center: CLLocationCoordinate2D(latitude: 42.508432, longitude: -70.888915), radius: 100, images: [stuff]))
